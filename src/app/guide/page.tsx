            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {[
                        ...
                        { term: "Monthly Free Cash Flow", def: "The calculated amount of cash left over from your core income. Basis: [Base Salary] - ([Bank Loan Payments] + [Kuwait Household Expenses]). Note: Rental income and out-of-country (EGP) expenses are excluded from this core survival metric." },
                        ...
                        { term: "Emergency Liquid Capital", def: "Cash or assets that can be instantly converted to cash within 24 hours without significant loss of value. Basis: [Cash in the Bank] + [Physical Gold Holdings] + [Physical Silver Holdings]. Excludes illiquid assets like property." },
